...
export default function SkiningBlending() {
  function onContextCreate(canvas: HTMLCanvasElement) {
    ...
    let model: any, skeleton: THREE.Object3D<THREE.Event> | THREE.SkeletonHelper,
      mixer: THREE.AnimationMixer, clock: THREE.Clock;
